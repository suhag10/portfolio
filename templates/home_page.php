            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="about_text pt-70">
                        <p>                
                            I'm a Junior web developer with 2 years of experience. 
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6 pe-5">
                    <div class="skill_img">
                        <img src="<?php echo './assets/img/skill/skill-1.jpg';?>" alt="..." class="img-fluid">
                    </div>
                </div>
                <div class="col-xl-6">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 d-flex justify-content-center">
                        <div class="any_project_btn">
                            <a href="tel:<?php echo $ui_number;?>" class="theme_btn cta_btn-one">Call Me</a>
                            <a href="mailto:<?php echo $ui_email;?>" class="theme_btn cta_btn-two">Give a Mail</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="single_experience">
                        <div class="experience_content">
                            ...
                            <div class="experience_title ml-20">
                                <span><a href="<?php echo $social_link['fiverr'];?>" target="_blank">Fiverr.com [2021]</a></span>
                                <h3><a href="<?php echo $social_link['fiverr'];?>" target="_blank">Web Development</a></h3>
                            </div>
                        </div>
                        ...
                        <div class="single_timeline d-none">
                            <div class="timeline_content">
                                ...
                                <h2>Bachelor of Social Science (BSS)</h2>
                              	<?php //BSS Certificate___Bachelor of Social Science; ?>
                                <p class="d-none">Lorem ipsum dolor sit amet,</p>
                            </div>
                        </div>
                        <!-- MC College -->
                      	<div class="single_timeline">
                            <div class="timeline_content">
                                <span>Freelancerlab, Sylhet. [2021]</span>
                                <h2>Website Development Certificate</h2>
                                <p class="d-none">Lorem ipsum dolor sit amet,</p>
                            </div>
                        </div>
                        <div class="single_timeline">
                            <div class="timeline_content">
                                ...
                                <h2>LEDP Graphic Design Certificate</h2>
                                <p class="d-none">Lorem ipsum dolor sit amet,</p>
                            </div>
                        </div>                      
                        <div class="single_timeline">
                ...
                <div class="col-xl-7 col-lg-7">
                    <div class="education_img">
                        <div class="education_img_one ps-5">
                            <img src="<?php echo './assets/img/education/education-1.jpg';?>" alt="..." class="img-fluid">
                        </div>
                        <div class="education_img_two">
                            <img src="<?php echo './assets/img/education/education-2.jpg';?>" alt="..." class="img-fluid">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-12 fix">
                    <div class="testimonial_active owl-carousel owl-theme">
    ...
    <!-- script -->
    <script>$('#nav_menu > .home').addClass('active');</script>
